...
class MySeizureDataset(nn.Module):
    def __init__(self, edf_file, label_file, window_size_sec=25, fs=256):
        super(MySeizureDataset, self).__init__()
        ...
        annotations = Annotations.loadTsv(label_file)
        self.mask = annotations.getMask(eeg.fs)
    ...
    def __getitem__(self, idx):
        ...
        mask_clip = self.mask[self.window_idx[idx]:self.window_idx[idx]+self.window_size]
